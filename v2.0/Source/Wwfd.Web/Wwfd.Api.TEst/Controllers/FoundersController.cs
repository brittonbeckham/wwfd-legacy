...
namespace Wwfd.Web.Api.Controllers
{
	public class FoundersController : ApiController
	{
		...
		/// <returns></returns>
		[Route("Founders/GetByName/{firstname}/{lastname}")]
		...
		/// <returns></returns>
		[Route("Founders/GetWithQuoteCountByName/{firstname}/{lastname}")]
		...
		/// <param name="id"></param>
		/// <returns></returns>
		[Route("Founders/GetWithQuoteCountById/{id}")]
